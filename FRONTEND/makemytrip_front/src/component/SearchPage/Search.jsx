//search flight for Mumbai to Bangalore , Delhi to mumbai,Kolkata to mumbai
...
export const Search = () => {
  ...
  const handleSort = (e) => {
    if (e === true) {
      const sortedList = [...dataa].sort((a, b) => +a.price - +b.price);
      setData(sortedList);
    }
  };
  const handleHigh = (e) => {
    if (e === true) {
      const sortedList = [...dataa].sort((a, b) => +b.price - +a.price);
      setData(sortedList);
    }
  };
